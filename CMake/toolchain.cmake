...
if(NOT YOTTA_CFG_MICROBIT_DAL_RAM_SIZE)
    message(WARNING "No definition of YOTTA_CFG_MICROBIT_DAL_RAM_SIZE found, building image for default 16K target.")
    set(YOTTA_CFG_MICROBIT_DAL_RAM_SIZE "16K")
else()
    # Ensure that the string is uppercase to build the macro definitions correctly
    string(TOUPPER "${YOTTA_CFG_MICROBIT_DAL_RAM_SIZE}" YOTTA_CFG_MICROBIT_DAL_RAM_SIZE)
    if(YOTTA_CFG_MICROBIT_DAL_RAM_SIZE STREQUAL "16K")

    elseif(YOTTA_CFG_MICROBIT_DAL_RAM_SIZE STREQUAL "32K")
     
    else()
        # Fail if the RAM size is not supported
        message(FATAL_ERROR "Cannot build image for target with RAM size '${YOTTA_CFG_MICROBIT_DAL_RAM_SIZE}'. Please modify your yotta config to set YOTTA_CFG_MICROBIT_DAL_RAM_SIZE a supported option.\nSupported RAM sizes: '16K' (default), '32K'.")
    endif()
endif()

# legacy definitions for building mbed 2.0 modules with a retrofitted build
# system:
set(MBED_LEGACY_TARGET_DEFINITIONS "NORDIC" "NRF51_CALLIOPE" "MCU_NRF51822" "MCU_NRF51_16K" "MCU_NORDIC_16K" "MCU_NRF51_16K_S110")
# provide compatibility definitions for compiling with this target: these are
# definitions that legacy code assumes will be defined.
add_definitions("-DNRF51 -DTARGET_NORDIC -DTARGET_M0 -D__MBED__=1 -DMCU_NORDIC_16K -DTARGET_NRF51_CALLIOPE -DTARGET_MCU_NORDIC_16K -DTARGET_MCU_NRF51_16K_S110  -DTARGET_NRF_LFCLK_RC -DTARGET_MCU_NORDIC_16K -D__CORTEX_M0 -DARM_MATH_CM0 -DNO_BLE")

# append non-generic flags, and set NRF51822-specific link script
set(_CPU_COMPILATION_OPTIONS "-mcpu=cortex-m0 -mthumb -D__thumb2__ -fconserve-stack")
...
set(CMAKE_EXE_LINKER_FLAGS_INIT    "${CMAKE_EXE_LINKER_FLAGS_INIT} -mcpu=cortex-m0 -mthumb -T\"${CMAKE_CURRENT_LIST_DIR}/../ld/NRF51822_${YOTTA_CFG_MICROBIT_DAL_RAM_SIZE}.ld\"")
